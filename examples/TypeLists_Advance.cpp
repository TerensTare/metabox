...
int main()
{
    ...
    constexpr auto fundamental = tnt::bind_value_fn<std::is_fundamental>;
    constexpr auto integral = tnt::bind_value_fn<std::is_integral>;
    constexpr auto reference = tnt::bind_value_fn<std::is_reference>;
    ...
    constexpr auto add_ref = tnt::bind_type_fn<std::add_lvalue_reference>;
